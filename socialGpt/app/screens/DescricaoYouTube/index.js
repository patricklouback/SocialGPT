...
export default function Page() {
  ...
  return (
    <Container>
      ...
      <Title>Descrição para Vídeo</Title>
      <Description>Digite o assunto do seu vídeo:</Description>
      ...
      <AreaBtn2>
        <View>
          <BtnType width="144px" color="#FFB347">
            <BtnText color="#4A4A4A">Copiar Descrição</BtnText>
          </BtnType>
          <BtnType width="144px" color="#9BDBB1">
            <BtnText color="#4A4A4A">Outro Descrição</BtnText>
          </BtnType>
        </View>

        <BtnType width="144px" height="93px" color="#5965E0">
          <BtnText>Salvar Descrição</BtnText>
        </BtnType>
      </AreaBtn2>
      <Line />
